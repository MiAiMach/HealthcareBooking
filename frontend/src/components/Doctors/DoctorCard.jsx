    ...
    <div className="p-3 ;g:p-5">
        ...
        <div className="mt-2 lg:mt-4 flex item-center justify-between">
            ...
            <div className="flex items-center gap-[6px]">
                ...
                <span className='flex items-center gap-[6px] text-[14px] leading-6 lg:text-[16px] leading-7 font-semibold text-textColor'>({totalRating})</span>
            </div>
        </div>
