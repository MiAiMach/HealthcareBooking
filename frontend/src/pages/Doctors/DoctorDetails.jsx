          ...
          <div className='md:cols-span-2'>
            <div className="flex items-center gap-5">
              ...
              <div>
                ...
                <h3 className='text-headingColor text-[22px] leading-9 mt-3 font-bold'>Mi Mach</h3>
                <div className="flex items-center gap-[6px]">
                  ...
                  <p className='text__para text-[14px] text-textColor leading-6 md:text-[15px] lg:max-w-[390px]'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Dicta, alias!</p>
              </div>
            </div>
