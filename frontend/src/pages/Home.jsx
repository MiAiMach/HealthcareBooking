        ...
        <div>
          ...
          <div className='mt-[30px] lg:mt-[70px] flex flex-col lg:flex-row lg:items-center gap-5 lg:gap-[30px]'>
            <div>
              ...
              <span className='w-[100px] h-2 bg-yellowColor rounded-full block mt-[-14px] mb-3'></span>
            ...
            <div>
              ...
              <span className='w-[100px] h-2 bg-purpleColor rounded-full block mt-[-14px] mb-3'></span>
              <p>Clinic Location</p>
            </div>
            ...
            <div>
              ...
              <span className='w-[100px] h-2 bg-irisBlueColor rounded-full block mt-[-14px] mb-3'></span>
  ...
  <section>
    <div className='container'>
      <div className='lg:w-[470px] mx-auto'>
        <h2 className='heading text-center mb-3'>Providing the best medical services</h2>
    ...
    <div className="container">
      <div className="flex items-center justify-between flex-col lg:flex-row">
        ...
        <div className="xl:w-[670px]">
          ...
          <ul className="pl-4">
            <li className="text__para text-textColor mb-4">
